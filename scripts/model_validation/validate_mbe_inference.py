...
Example:
  python -m scripts.model_validation.validate_mbe_inference \
    --hf-model gpt2 \
...
from falcon.models.mbe_layernorm import replace_layernorm_with_mbe, replace_layernorm_with_mbe_map
