...
Examples:
  python -m scripts.model_validation.sample_wikitext --num-samples 500
  python -m scripts.model_validation.sample_wikitext --subset wikitext-2-raw-v1 --split test --num-samples 200
"""
