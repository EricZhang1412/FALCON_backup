...
Usage:
    python run_comparison.py [config_name] [--epochs N] [--budget B]

Example:
    python run_comparison.py gelu_conversion --epochs 300 --budget 64
"""
...
from conversion.train import train_conversion_model, evaluate_dense_grid
