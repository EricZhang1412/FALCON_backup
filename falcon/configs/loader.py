...
from falcon.configs.base import FALLBACK_DEVICE, FALLBACK_DTYPE, FALLBACK_SEED, FALLBACK_T, coerce_dtype

YAML_ROOT = Path(__file__).resolve().parents[2] / "configs" / "yaml"
