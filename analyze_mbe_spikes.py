...
Usage examples:
  python analyze_mbe_spikes.py tanh_conversion --comparison-mode lti
  python analyze_mbe_spikes.py tanh_conversion --use-lti
  python analyze_mbe_spikes.py tanh_conversion --checkpoint /path/to/best.pt
"""
...
from conversion.data import sample_inputs
